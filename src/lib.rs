// src/lib.rs
/*
 * Core library for NanoDiscourse
 */
...
#[derive(Debug)]
pub struct NanoDiscourseProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NanoDiscourseProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NanoDiscourse processing");
    
    let mut processor = NanoDiscourseProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NanoDiscourseProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NanoDiscourseProcessor::new(false);
